...
// ================= Workbench =================	
		...
		glVertex3f(Pointx2, Pointy1, Pointz1); // �յ�����

		glVertex3f(Pointx1, Pointy1, Pointz1); // �������
		glVertex3f(Pointx1, Pointy1, Pointz2); // �յ�����

		glVertex3f(Pointx1, Pointy1, Pointz2); // �������
		glVertex3f(Pointx2, Pointy1, Pointz2); // �յ�����
		...
		glVertex3f(Pointx2, Pointy2, Pointz1); // �յ�����

		glVertex3f(Pointx1, Pointy2, Pointz1); // �������
		glVertex3f(Pointx1, Pointy2, Pointz2); // �յ�����

		glVertex3f(Pointx1, Pointy2, Pointz2); // �������
		glVertex3f(Pointx2, Pointy2, Pointz2); // �յ�����

		glVertex3f(Pointx2, Pointy2, Pointz1); // �������
		glVertex3f(Pointx2, Pointy2, Pointz2); // �յ�����

		glVertex3f(Pointx1, Pointy1, Pointz1); // �������
		glVertex3f(Pointx1, Pointy2, Pointz1); // �յ�����
